...
class KFoldCrossValidation_LinearRegression():
  __RANDOM_SEED = 1
  ...
  def search(self, params):
    ...
    for ind_feature in features_length:
      ...
      for i in range(len(X_trains)):
        model_linear_regression = Model_LinearRegression(error_fun=self.loss)
      ...
      print([mean, std, {"features_length": ind_feature}, model_linear_regression])
      cross_validation_results.append([mean, std, {"features_length": ind_feature}, model_linear_regression])
